...
const translations: Record<Language, Record<string, string>> = {
    pt: {
        ...
        realtime_writing: "Escreva pelo Celular",
        realtime_writing_desc: "Use seu celular como tablet de escrita para o PC.",
        placement_test: "Prova de Avaliação de Nível",
        placement_test_desc: "Teste seu conhecimento e pule níveis. 10 questões por nível.",
        ...
        level_n3_kanji_title: "Kanji Intermediário (N3)",
        level_n3_kanji_desc: "Expandindo horizontes com novos ideogramas.",
        level_n3_vocab_title: "Vocabulário N3",
        level_n3_vocab_desc: "Expressões para o dia a dia e trabalho.",
        level_n3_final_title: "Desafio N3",
        level_n3_final_desc: "Prove que você domina o nível intermediário.",

        level_n2_kanji_title: "Kanji Avançado (N2)",
        level_n2_kanji_desc: "Ideogramas para leitura de jornais e revistas.",
        level_n2_vocab_title: "Vocabulário N2",
        level_n2_vocab_desc: "Palavras formais e técnicas.",
        level_n2_final_title: "Mestre N2",
        level_n2_final_desc: "Um passo para a fluência total.",

        level_n1_kanji_title: "Kanji Supremo (N1)",
        level_n1_kanji_desc: "Domine todos os ideogramas de uso comum.",
        level_n1_vocab_title: "Vocabulário N1",
        level_n1_vocab_desc: "Nuances e expressões nativas.",
        level_n1_final_title: "Lenda N1",
        level_n1_final_desc: "O teste final para se tornar um mestre.",
        ...
        view_full_dashboard: "Ver Painel Completo",
        invite_history: "Histórico de Convites",
        view_invite_history: "Ver Histórico de Convites",
        advanced_invite_generator: "Gerador de Convites Avançado",
        connect_with_school: "Conecte-se com sua escola.",
        open_chat: "Abrir Chat",
        settings: "Configurações",
        invite_generator: "Gerador de Convites",
        ...
        family: "Família",
        all: "Todos",
        no_invites_found: "Nenhum convite encontrado",
    ...
    jp: {
        ...
        reset_game: "ゲームをリセット",
        view_full_dashboard: "完全なダッシュボードを見る",
        invite_history: "招待履歴",
        view_invite_history: "招待履歴を見る",
        advanced_invite_generator: "高度な招待ジェネレーター",
        connect_with_school: "学校とつながりましょう。",
        open_chat: "チャットを開く",
        settings: "設定",
        invite_generator: "招待ジェネレーター",
        user_type: "ユーザータイプ",
    ...
    en: {
        ...
        view_invite_history: "View Invitation History",
        advanced_invite_generator: "Advanced Invite Generator",
        connect_with_school: "Connect with your school.",
        open_chat: "Open Chat",
        settings: "Settings",
        invite_generator: "Invite Generator",
        user_type: "User Type",
        ...
        family: "Family",
        all: "All",
        no_invites_found: "No invites found",
        unknown: "Unknown",
        uses: "uses",
        created: "Created",
        expires: "Expires",
